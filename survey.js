        ...
        rl.question("What's your favourite thing to eat for that meal?", (answer5) => {
          ...
          rl.question("Which sport is your absolute favourite?", (answer6) => {
            ...
            rl.question("What is your superpower? In a few words, tell us what you are amazing at!", (answer7) => {
              ...
              console.log(`Your name you provided was ${answer1}, and you enjoy to do ${answer2} while listening to ${answer3}. Your favourite meal time is at ${answer4}, and you enjoy eating ${answer5} for that meal. You also like ${answer6}, and your superpower is ${answer7}!`)
